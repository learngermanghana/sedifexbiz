...
assert.equal(isSmsAutomationEnabledForStage(defaults, 'booking_received'), true)
assert.equal(isSmsAutomationEnabledForStage(defaults, 'booking_confirmed'), true)
assert.equal(isSmsAutomationEnabledForStage(defaults, 'booking_rescheduled'), true)
assert.equal(isSmsAutomationEnabledForStage(defaults, 'booking_cancelled'), true)
