...
export const EVENT_PRODUCTION_TEMPLATES: Record<string, EventProductionTemplate> = {
  'Traditional wedding': {
    ...
    fields: [
      ...
      common.invitation,
      common.seating,
      { key: 'bridalPartySize', label: 'Bridal / family party size', type: 'number' },
      common.tables,
  ...
  'White wedding': {
    ...
    fields: [
      ...
      common.invitation,
      common.seating,
      { key: 'bridalPartySize', label: 'Bridal party size', type: 'number' },
      common.tables,
  ...
  'Corporate event': {
    ...
    fields: [
      ...
      { key: 'eventTheme', label: 'Conference / event theme' },
  ...
  Engagement: {
    ...
    fields: [
      ...
      common.invitation,
      common.seating,
      { key: 'bridalPartySize', label: 'Family / bridal party size', type: 'number' },
      common.tables,
...
export function getEventProductionTemplate(eventType: string): EventProductionTemplate {
  ...
  if (normalized.includes('naming') || normalized.includes('christening')) return EVENT_PRODUCTION_TEMPLATES['Naming ceremony']
  if (normalized.includes('funeral') || normalized.includes('memorial')) return EVENT_PRODUCTION_TEMPLATES.Funeral
  if (normalized.includes('corporate') || normalized.includes('conference') || normalized.includes('business event')) return EVENT_PRODUCTION_TEMPLATES['Corporate event']
